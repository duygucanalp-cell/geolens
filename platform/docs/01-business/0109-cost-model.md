...
| Kalem | Aylık | 3 Aylık |
|-------|:-----:|:-------:|
| Engine API (3 motor, 100 ölçüm/ay) | $5.70 | $17.10 |
...
- **Limit aşımı alarmı:** `geolens_monthly_cost` metriği $80 eşiğinde uyarır
...
|:-----------|:-------------:|:-----------:|:-----------:|:-----:|
| Haftalık takip | Haftada 1 | ~4 | 1-5 | 3 |
| Aylık rapor | Ayda 1 | ~1 | 5-20 | 3 |
| Anlık ölçüm | Elle tetikleme | ~5 | 1 | 3 |

**Pilot öngörüsü:** 2 panel × 3 marka × 3 motor × 4 hafta = **72 ölçüm/ay**
